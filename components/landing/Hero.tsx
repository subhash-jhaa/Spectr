  ...
  return (
    <div className="theme-zinc w-full" style={{ "--radius": "0.5rem" } as React.CSSProperties}>
      <div className="flex min-h-full w-full items-center justify-center">
        <section className="relative isolate w-full min-h-screen translate-z-0 overflow-hidden px-4 pt-36 pb-16 sm:px-6 md:px-8 md:pt-48 lg:pt-52 md:pb-24 lg:pb-32 flex flex-col items-center bg-[#fafaf9] dark:bg-black">
          ...
          <div className="relative z-20 mx-auto flex max-w-5xl flex-col items-center justify-center text-center pt-8 sm:pt-14 pb-6 sm:pb-10">
